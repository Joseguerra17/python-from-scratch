...
#ordenando el dataframe por la edad, utilizamos la funcion sort(que ordena por default de menor a mayor)
...
#accediendo a las primeras filas con head(), | Dato -> siempre mostrara las filas anteriores al numero de fila que le estemos pidiendo en este caso head(3)
...
#accediendo a un elemento especifico del dataframe (df) con loc, en este caso al apellido de la fila 1, accedemos por el nombre de la columna
elemento_especifico_loc = df.loc[1, "apellido"]

#accediendo a un elemento especifico del dataframe (df) con iloc, esta vez por el indice
